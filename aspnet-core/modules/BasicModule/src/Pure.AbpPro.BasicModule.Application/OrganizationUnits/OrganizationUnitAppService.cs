namespace Pure.AbpPro.BasicModule.OrganizationUnits;

[Authorize(Policy = BasicModulePermissions.SystemManagement.OrganizationUnitManagement.Default)]
public class OrganizationUnitAppService : BasicModuleAppService, IOrganizationUnitAppService
{
    ...
    [Authorize(BasicModulePermissions.SystemManagement.OrganizationUnitManagement.Create)]
    ...
    [Authorize(BasicModulePermissions.SystemManagement.OrganizationUnitManagement.Delete)]
    public virtual Task DeleteAsync(IdInput input)
    {
        return _organizationUnitManager.DeleteAsync(input.Id);
    }

    [Authorize(BasicModulePermissions.SystemManagement.OrganizationUnitManagement.Update)]
    ...
    public virtual async Task<PagedResultDto<GetOrganizationUnitUserOutput>> GetUsersAsync(GetOrganizationUnitUserInput input)
    {
        ...
        if (organizationUnit == null) throw new BusinessException(BasicModuleErrorCodes.OrganizationUnitNotExist);
