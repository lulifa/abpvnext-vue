...
namespace Pure.AbpPro.BasicModule.Users
{
    ...
    public class UserAppService : BasicModuleAppService, IUserAppService
    {
        ...
        /// 用户导出列表
        /// </summary>
        [Authorize(BasicModulePermissions.SystemManagement.UserExport)]
        ...
        /// <returns></returns>
        [Authorize(BasicModulePermissions.SystemManagement.UserEnable)]
