namespace Pure.AbpPro.BasicModule.AuditLogs
{
    [Authorize(Policy = BasicModulePermissions.SystemManagement.AuditLog)]
    public class AuditLogAppService : BasicModuleAppService, IAuditLogAppService
    {
