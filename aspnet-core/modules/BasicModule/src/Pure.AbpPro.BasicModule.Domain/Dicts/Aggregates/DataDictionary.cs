namespace Pure.AbpPro.BasicModule.Dicts.Aggregates;
...
public class DataDictionary : FullAuditedAggregateRoot<Guid>, IMultiTenant
{
    ...
    /// </summary>
    [Required]
    [MaxLength(DataDictionaryConst.Code)]
    ...
    /// </summary>
    [Required]
    [MaxLength(DataDictionaryConst.DisplayText)]
    ...
    /// </summary>
    [Required]
    [MaxLength(DataDictionaryConst.Description)]
    ...
    {
        Guard.NotNullOrWhiteSpace(code, nameof(code), DataDictionaryConst.Code);
        Code = code;
    }

    private void SetDisplayText(string displayText)
    {
        Guard.NotNullOrWhiteSpace(displayText, nameof(displayText), DataDictionaryConst.DisplayText);
        DisplayText = displayText;
    }

    private void SetDescription(string description)
    {
        Guard.Length(description, nameof(description), DataDictionaryConst.Description);
        ...
        string description = "", bool isEnabled = true)
    {
        ...
        {
            throw new DataDictionaryDomainException(BasicModuleErrorCodes.DataDictionaryDetailExist);
        }
    ...
    public void RemoveDetail(string detailCode)
    {
        ...
        if (null == detail)
        {
            throw new DataDictionaryDomainException(BasicModuleErrorCodes.DataDictionaryDetailNotExist);
        }
